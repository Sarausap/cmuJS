<div class="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-12">
                <div class="white-box" style="height:96%;">
                    <div class="user-bg" style="height: 115%;">
                        <div class="overlay-box">
                            <div class="user-content" style="padding:15px 15px 0 15px">
                                <form class="form-horizontal form-material"
                                    ...
                                    <input type="hidden" style="display:none" name="role" value="admin">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12" class="form-control p-0 border-0">
                                <input type="text" placeholder="johnathan@admin.com" class="form-control p-0 border-0"
                                    name="password" id="example-email" value="<?php echo $user['pword'] ?>">
                            </div>
                        </div>
                        <div class="form-group mb-4">
    ...
    <div class="container-fluid">
        ...
        <!-- Three charts -->
        <!-- ============================================================== -->
        <div class="row justify-content-center" style="margin-top: -10em;margin-bottom:3em">
