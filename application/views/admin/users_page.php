	...
	<div class="page-breadcrumb bg-white">
		<div class="header row align-items-center">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h4 class="page-title" style="margin:">Manage Users</h4>
			</div>
			...
			<form style="width: fit-content;margin: unset;" action="<?php site_url("admin/users") ?>" method="post"
				id="filter_form">
				<input type="hidden" name="submit_status"
					value="<?= !is_null($submit_status) && !is_null($selected_id) ? '1' : '0' ?>">
				...
				<select name='role' id='role' style='width:100px;'>
					...
					<?php foreach ($roles as $role): ?>
						<option value="<?php echo $role['role_id'] ?>" <?= !is_null($selected_id) && $role['role_id'] == $selected_id ? 'selected' : '' ?>><?php echo $role['name'] ?>
						</option>
					<?php endforeach ?>
				</select>
