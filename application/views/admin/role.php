            ...
            <div class="modal-body py-0">
                <div class="d-flex main-content">
                    <div class="content-text p-4" style="width:100%">
                        <h3 style="margin:0 auto; width:fit-content">Add Role</h3>
                        <form action="<?php echo site_url('admin/role/add'); ?>" method="post">
                            <div class="form-group">
                                <label for="add-name">Role Name</label>
    ...
    <div class="modal-dialog modal-md  modal-dialog-centered" role="document">
        <div class="modal-content rounded-0">
            <div class="modal-body py-0">
                <div class="d-flex main-content">
                    <div class="content-text p-4" style="width:100%">
                        <h3 style="margin:0 auto; width:fit-content">Edit Role</h3>
                        <form action="<?php echo site_url('admin/role/update'); ?>" method="post">
                            ...
                            <tbody>
                                <?php foreach ($roles as $role): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $formattedDate = date('F j, Y', strtotime($role['date_created']));
                                            echo $formattedDate; ?>
                                        </td>
                                        <td
                                            ...
                                            <a style="width: 5em;" href="#" data-user-id="<?php echo $role['role_id']; ?>"
...
<script>
    ...
    $(document).ready(function () {
        $(document).on('click', '.edit-btn', function (event) {
            ...
            console.log(userId)
            $.ajax({
                url: '<?php echo site_url('role/get_role_by_id'); ?>',
                type: 'GET',
                data: {
                    id: userId
                },
                ...
                success: function (userData) {
                    ...
                    console.log(document.getElementById('roleId'))
