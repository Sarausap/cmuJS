...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <!-- ============================================================== -->
        <aside class="left-sidebar" data-sidebarbg="skin6" style="padding-top: 25px !important;">
            <!-- Sidebar scroll-->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li style="margin-top: 50px;">
                            <a class="profile-pic" href="#">
                                ...
                                <span class="text-white font-medium"
                                    style="margin-top: unset;font-weight: 200;">Contributer</span></a>
                        </li>
                        <li class="sidebar-item" style="margin-top:30px;">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo site_url("user/dashboard") ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo site_url("user/profile") ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo site_url("user/article") ?>" aria-expanded="false">
