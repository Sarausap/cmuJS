                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="<?php echo base_url("assets/plugins/images/users/varun.jpg") ?>"
                                    ...
                                    class="text-white font-medium"><?php echo $_SESSION['name'] ?></span></a>
                        </li>
                        <li class="sidebar-item" style="margin-top:30px;">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo site_url("evaluator/dashboard") ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo site_url("evaluator/profile") ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo site_url("evaluator/articles") ?>" aria-expanded="false">
                                <i class="fa fa-users" aria-hidden="true"></i>
                                <span class="hide-menu">Evalations</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
